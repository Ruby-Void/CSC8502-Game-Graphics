...
void Renderer::ToggleRepeating() {
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, /*x axis*/ repeating ? GL_REPEAT : GL_CLAMP);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, /*y axis*/  repeating ? GL_REPEAT : GL_CLAMP);
