...
Renderer::Renderer(Window& parent) : OGLRenderer(parent), waterRotate(0.0f) {
	camera = new Camera();
	...
	reflectShader = new Shader(SHADERDIR"PerPixelShaders/PerPixelVertex.glsl", SHADERDIR"ReflectFragment.glsl");
	skyboxShader = new Shader(SHADERDIR"SkyboxShaders/SkyboxVertex.glsl", SHADERDIR"SkyboxShaders/SkyboxFragment.glsl");
	lightShader = new Shader(SHADERDIR"PerPixelShaders/PerPixelVertex.glsl", SHADERDIR"PerPixelShaders/PerPixelFragment.glsl");
